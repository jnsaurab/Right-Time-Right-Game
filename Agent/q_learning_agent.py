...
class QLearningAgent(BaseAgent):
    ...
    def getAction(self, stateTime, stateDay, stateLastNotification):
        super().getAction(stateTime, stateDay, stateLastNotification)
        state = (stateTime, stateDay, stateLastNotification)
